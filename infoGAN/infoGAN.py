...
class infoGAN(object):  #初始化函数
    ...
    def __init__(self, sess, epoch, batch_size, z_dim, dataset_name, checkpoint_dir, result_dir, log_dir, SUPERVISED=True):
        ...
        if dataset_name == 'mnist' or dataset_name == 'fashion-mnist':
            ...
            self.y_dim = 12         # dimension of code-vector (label+two features)  控制变量
    ...
    def build_model(self):
        ...
        # continuous code : gaussian(MSE：高斯分布的拉近)
    ...
    def train(self):
        ...
        # summary writer
        self.writer = tf.summary.FileWriter(self.log_dir + '/' + self.model_name + '/' + self.dataset_name, self.sess.graph)
